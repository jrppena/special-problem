...
const classSchema = new mongoose.Schema({
  ...
  gradeLevel: { type: Number, required: true, enum:[7,8,9,10] }, // e.g., 7, 8, 9, 10
  schoolYear: { type: String, required: true }, // e.g., "2024-2025"
  teachers: [{ type: mongoose.Schema.Types.ObjectId, ref: "Teacher", required: true }], // Assigned teacher
